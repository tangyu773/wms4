...
folder are mapped to the application's root namespace, 'PtAdmin'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'PtAdmin' in the same way
as `"PtAdmin/sass/src"`.
