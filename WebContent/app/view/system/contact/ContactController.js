Ext.define('Admin.view.system.contact.ContactContraller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.system_contact',
	...
	_loadData : function(page){
        var ulists =Ext.ComponentQuery.query("container[name='system_contact']");
